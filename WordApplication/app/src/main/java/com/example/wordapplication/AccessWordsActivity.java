...
public class AccessWordsActivity extends AppCompatActivity {
    private static final String TAG="MyWordsTag";
    private ContentResolver resolver;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_access_words);
        ...
        All.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Cursor cursor = resolver.query(Words.Word.CONTENT_URI,
                        ...
                        null, null, null);
                if (cursor == null) {
                    Toast.makeText(AccessWordsActivity.this, "没有找到记录", Toast.LENGTH_LONG).show();
                    return;
                }
                String msg = "";
